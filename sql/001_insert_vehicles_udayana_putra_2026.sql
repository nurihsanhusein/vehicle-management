...
USING (
	...
	UNION ALL
	SELECT 'DR8352AR', 'DR8352AR', 'HINO', 'J08EUGJ75722', 'MJEFG8JJ1KJ813650', CAST('2019-01-17' AS DATETIME), '7 tahun, 23 hari', 0.35, 200, 13, 10, 2, 13, 1, 1, 1, 'ENGKEL'
	UNION ALL
	SELECT 'L8170UUD', 'L8170UUD', 'HINO', 'J08EWEJ11081', 'MJEFL8JN2NJP10109', CAST('2017-07-19' AS DATETIME), '8 tahun, 4 bulan, 26 hari', 0.4, 200, 13, 16, 2, 13, 1, 1, 1, 'TRONTON'
	UNION ALL
	SELECT 'L8184UT', 'L8184UT', 'HINO', 'N04CWYJ24251', 'MJECCB2F8P5014179', CAST('2023-09-30' AS DATETIME), '2 tahun, 6 bulan, 11 hari', 0.4, 200, 13, 5, 1, 13, 1, 1, 1, 'ENGKEL'
	UNION ALL
	SELECT 'L8169UUD', 'L8169UUD', 'HINO', 'N04CWYJ13228', 'MJECCB2F6N5003632', CAST('2022-12-29' AS DATETIME), '4 tahun, 1 bulan, 12 hari', 0.25, 100, 8, 5, 1, 8, 1, 1, 1, 'ENGKEL'
	UNION ALL
	SELECT 'L8188UT', 'L8188UT', 'HINO', 'J08EWEJ16751', 'MJEFL8JN2PJP10601', CAST('2023-09-30' AS DATETIME), '2 tahun, 6 bulan, 11 hari', 0.4, 200, 13, 16, 2, 13, 1, 1, 1, 'TRONTON'
	UNION ALL
	SELECT 'DR8656AH', 'DR8656AH', 'HINO', 'JD8EWMJ10590', 'MJEFG8JK1LJJ11217', CAST('2020-03-12' AS DATETIME), '5 Tahun, 2 bulan, 11 hari', 0.35, 200, 13, 10, 2, 13, 1, 1, 1, 'ENGKEL'
	UNION ALL
	SELECT 'L8171UUD', 'L8171UUD', 'HINO', 'N04CWYJ13377', 'MJECCB2F2N5003806', CAST('2022-12-29' AS DATETIME), '4 Tahun, 1 bulan 11 hari', 0.25, 100, 8, 5, 1, 8, 1, 1, 1, 'ENGKEL'
	UNION ALL
	SELECT 'DR8592AF', 'DR8592AF', 'HINO', 'W04DTRR-33275', 'MJEC1JG43G5-139581', CAST('2016-04-05' AS DATETIME), '9 tahun, 9 bulan, 11 hari', 0.25, 100, 8, 5, 1, 8, 1, 1, 1, 'ENGKEL'
	UNION ALL
	SELECT 'DR8591AF', 'DR8591AF', 'HINO', 'W04DTRR-33273', 'MJEC1JG43G5-139583', CAST('2016-04-05' AS DATETIME), '9 tahun, 9 bulan, 11 hari', 0.25, 100, 8, 5, 1, 8, 1, 1, 1, 'ENGKEL'
) AS SOURCE
...
WHERE [CreatedBy] = 'nurihsanhusein' 
	AND [Status] = 'APPROVED'
	AND [LicensePlate] IN (
		'DR8593AF', 'DR8352AR', 'L8170UUD', 'L8184UT', 'L8169UUD',
		'L8188UT', 'DR8656AH', 'L8171UUD', 'DR8592AF', 'DR8591AF'
	)
